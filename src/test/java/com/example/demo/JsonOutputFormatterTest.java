...
class JsonOutputFormatterTest {
    ...
    void testPrint_MultipleBuckets() {
        ScheduleBucket bucket1 = new ScheduleBucket(10, 0, Collections.emptyMap());
        
        Map<String, Integer> allocations2 = new LinkedHashMap<>();
        allocations2.put("CustomerC", 2);
        ScheduleBucket bucket2 = new ScheduleBucket(11, 2, allocations2);
    ...
    void testPrint_Escaping() {
        ...
        ScheduleBucket bucket = new ScheduleBucket(12, 1, allocations);
